...
function BookingModal({ open, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError("Could not reach the desk. Please call +91 98765 00008.");
    } finally {
      setSending(false);
    }
  };
    ...
    <>
      ...
      <div className={"bm-shell " + (open ? "open" : "")} role="dialog" aria-label="Schedule a viewing">
        <header className="bm-head">
          <div>
            <div className="bm-eyebrow"><span className="bm-rule"/>R S Real Estate · Reservation Desk</div>
        ...
        {sent ? (
          ...
          <form className="bm-grid" onSubmit={submit}>
            ...
            <aside className="bm-col bm-col-summary">
              ...
              <Row k="Office"   v="SCF-19, 2nd Floor · Phase 7 · Mohali · 160062" />
              ...
              <a href="tel:+919876500008" className="bm-call">Or call the desk · +91 98765 00008</a>
            </aside>
          </form>
        )}
      </div>
