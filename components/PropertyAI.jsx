...
const SYSTEM_PROMPT = `You are Property AI, the digital concierge for R S Real Estate — a trusted real estate agency in the Mohali tri-city (Mohali, Chandigarh, Zirakpur, Kharar, New Chandigarh).

Firm facts:
- Firm: R S Real Estate
- Office: SCF-19, 2nd Floor, Sector 79, Sahibzada Ajit Singh Nagar, Punjab 140308
...
function PropertyAI({ onSchedule }) {
  ...
  const send = async (text) => {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: "assistant", content: "I can't reach my brain right now. Please call the desk on +91 98765 00008 — they'll be happy to help." }]);
    } finally {
      setSending(false);
    }
  };
