    ...
    <>
          ...
          <a href="#top" onClick={() => setMobileOpen(false)} style={{ display: "flex", alignItems: "center", gap: 14, zIndex: 1 }}>
            ...
            <div style={{ lineHeight: 1.05 }}>
              <div className="clash" style={{ fontSize: 20, letterSpacing: "-0.03em", color: navInk, transition: "color 250ms ease" }}>
                R S Real Estate <span style={{ fontFamily: "Gambarino, Georgia, serif", fontStyle: "italic", fontWeight: 400, letterSpacing: "-0.02em" }}>Realty</span>
              </div>
      ...
      <div className={"mobile-nav " + (mobileOpen ? "open" : "")}>
        ...
        <div style={{ marginTop: 40, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >Schedule a Viewing →</button>
          <a href="tel:+919876500008" className="uc" style={{ fontSize: 12, letterSpacing: "0.14em", color: "var(--mute)", textAlign: "center" }}>
            +91 98765 00008
          </a>
        </div>
      </div>
        ...
        <div className="hero-bottom hero-fade-late" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", borderTop: "1px solid rgba(255,255,255,0.18)", paddingTop: 22, gap: 20, flexWrap: "wrap" }}>
          <div>
            ...
            <div className="clash" style={{ fontSize: 16, letterSpacing: "-0.02em", color: "#ffffff", fontWeight: 500 }}>
              SCF-19, 2nd Floor · Sector 79, SAS Nagar
            </div>
          </div>
          <div style={{ display: "flex", gap: 18, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <a href="tel:+919876500008" className="uc" style={{ fontSize: 11, letterSpacing: "0.18em", color: "rgba(255,255,255,0.72)" }}>
              +91 98765 00008
            </a>
          </div>
        </div>
    ...
    <section id="practice" className="manifesto">
      <div className="container">
        ...
        <div className="manifesto-credit">
          <span className="manifesto-sig">— R S Real Estate</span>
      ...
      {!sent ? (
        ...
        >
          ...
          <div style={{ gridColumn: "1 / -1", display: "flex", gap: 16, alignItems: "center", marginTop: 8, flexWrap: "wrap" }}>
            ...
            <a href="tel:+919876500008" className="uc" style={{ fontSize: 12, letterSpacing: "0.14em", color: "var(--mute)" }}>
              or call +91 98765 00008
            </a>
          </div>
        </form>
      ) : (
        ...
        <div className="principal-grid">
          <div>
            <div className="principal-frame">
              <img src="assets/sachdeva-about.jpg" alt="R S Real Estate office interior" />
            </div>
          ...
          <div className="principal-right">
            ...
            <h2 className="principal-name">Satinder Singh Chadha</h2>
...
function Reviews() {
  const all = [
    { name: "Aman Khurana",    initial: "A", stars: 5, time: "2 months ago", text: "R S Real Estate closed our SCO purchase end-to-end. From paperwork to registry, every detail was handled with extraordinary discretion. The most professional agency in the region." },
    ...
    { name: "Sunita Puri",      initial: "S", stars: 5, time: "1 month ago", text: "Three transactions with R S Real Estate now. Their word is genuinely their bond. Wouldn't dream of going elsewhere." },
      ...
      <div className="container" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 56, alignItems: "flex-start" }}>
        <div className="about-photo-col" style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 360, width: "100%", justifySelf: "start" }}>
          ...
          <div style={{ border: "1px solid var(--line)", borderRadius: 6, padding: "20px 22px", background: "var(--paper)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14 }}>
            <div>
              <div className="clash" style={{ fontSize: 19, letterSpacing: "-0.02em", fontWeight: 600, lineHeight: 1.1 }}>R S Real Estate</div>
          ...
          >
            ...
            <div style={{ position: "absolute", left: 16, right: 16, bottom: 14, color: "#f6f6f6", display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 12 }}>
              <div>
                ...
                <div className="clash" style={{ fontSize: 15, letterSpacing: "-0.02em", marginTop: 4, fontWeight: 600 }}>SCF-19, 2nd Floor · Phase 7 · Mohali · 160062</div>
              </div>
        ...
        <div>
          ...
          <p className="clash" style={{ fontSize: "clamp(24px, 3.6vw, 48px)", letterSpacing: "-0.035em", lineHeight: 1.15, margin: 0, fontWeight: 500 }}>
            R S Real Estate is a <span className="serif-it">GMADA</span> empanelled and <span className="serif-it">RERA</span> registered firm specializing in residential, commercial and land mandates across the Mohali tri-city. Operating from SCF-19, 2nd Floor, Phase 7, Mohali, Punjab 160062.
          </p>
        ...
        <div className="desk-grid">
          ...
          <div className="desk-card">
            ...
            <div className="desk-row">
              ...
              <div className="desk-row-v"><a href="tel:+919876500008">+91 98765 00008</a></div>
            </div>
            <div className="desk-row">
              <div className="desk-row-k">By message</div>
              <div className="desk-row-v"><a href="mailto:chadha_in@yahoo.com">chadha_in@yahoo.com</a></div>
            </div>
            <div className="desk-row">
              <div className="desk-row-k">In person</div>
              <div className="desk-row-v">SCF-19, 2nd Floor<br/>Phase 7 · Mohali · 160062</div>
            </div>
...
function FooterMast() {
  return (
    <footer className="foot">
      <div className="container">
        <h2 className="foot-mast">R S Real Estate <em>Realty</em></h2>
        <div className="foot-cols">
          <div>
            <div className="foot-h">The Desk</div>
            <ul className="foot-list">
              <li><a href="tel:+919876500008">+91 98765 00008</a></li>
              <li><a href="mailto:chadha_in@yahoo.com">chadha_in@yahoo.com</a></li>
              <li><span>SCF-19, 2nd Floor</span></li>
              <li><span>Phase 7 · Mohali · 160062</span></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="foot-list">
              ...
              <li><a href="https://wa.me/919876500008" target="_blank" rel="noopener noreferrer">WhatsApp · Direct line</a></li>
            </ul>
          </div>
        </div>
        <div className="foot-bottom">
          <div className="foot-mark">
            <Crown />
            <span>© 2026 R S Real Estate · All rights reserved</span>
          </div>
      ...
      <div className="container">
        <div style={{ borderTop: "1px solid var(--ink-2)", paddingTop: 48, display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 32, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "flex-end" }}>
            <a href="tel:+919876500008" className="clash" style={{ fontSize: "clamp(22px,3.5vw,28px)", letterSpacing: "-0.02em", fontWeight: 600 }}>+91 98765 00008</a>
            <a href="https://wa.me/919876500008" target="_blank" rel="noopener noreferrer" style={{ fontSize: 16, color: "var(--mute)" }}>WhatsApp · +91 98765 00008</a>
            <a href="mailto:chadha_in@yahoo.com" className="uc" style={{ fontSize: 11, letterSpacing: "0.16em", marginTop: 8, borderBottom: "1px solid var(--ink)", paddingBottom: 4 }}>
              chadha_in@yahoo.com
            </a>
          </div>
        </div>
    ...
    <footer style={{ background: "var(--dark)", color: "rgba(246,246,246,0.6)", borderTop: "1px solid rgba(255,255,255,0.05)", marginTop: 40 }}>
      <div className="container" style={{ paddingTop: 72, paddingBottom: 40 }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 56 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <Crown dark />
              <div className="clash" style={{ color: "#f6f6f6", fontSize: 20, letterSpacing: "-0.03em" }}>R S Real Estate</div>
            </div>
            <p style={{ marginTop: 20, fontSize: 14, lineHeight: 1.65, maxWidth: 300 }}>
              Real estate agency & property experts in the Mohali tri-city. GMADA/RERA accredited. SCF-19, 2nd Floor, Phase 7, Mohali, Punjab 160062.
            </p>
          </div>
          ...
          <FooterCol head="Contact" links={[
            [<span><IconPhone/> +91 98765 00008</span>, "tel:+919876500008"],
            [<span><IconMail/> chadha_in@yahoo.com</span>, "mailto:chadha_in@yahoo.com"],
            [<span><IconPin/> SCF-19, 2nd Floor</span>, "#"],
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
          <div className="uc" style={{ fontSize: 10, letterSpacing: "0.18em" }}>© 2026 R S Real Estate — All rights reserved</div>
...
function WhatsAppFab() {
  ...
  const text = encodeURIComponent("Hello R S Real Estate — I would like to enquire about a property listing.");
  return (
    <a
